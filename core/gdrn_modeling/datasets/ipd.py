...
class IPD_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/ipd_bop_data/train_pbr"))
        ...
        self.models_root = data_cfg["models_root"]  # BOP_DATASETS/ipd/models_cad
    ...
    def models(self):
        ...
        for obj_name in self.objs:
            model = inout.load_ply(
                osp.join(self.models_root, f"obj_{ref.ipd.obj2id[obj_name]:06d}.ply"),
...
SPLITS_IPD_PBR = dict(
    ipd_train_pbr=dict(
        ...
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/ipd_bop_data/train_pbr"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/ipd_bop_data/models"),
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/ipd_bop_data/train_pbr/xyz_crop"),
...
def register_with_name_cfg(name, data_cfg=None):
    ...
    if name in SPLITS_IPD_PBR:
        ...
        used_cfg = data_cfg
    DatasetCatalog.register(name, IPD_PBR_Dataset(used_cfg))
