# encoding: utf-8
#edited by lucas H, copied from icbin.py
...
# ---------------------------------------------------------------- #
dataset_root = osp.join(bop_root, "ipd_bop_data") # change from icbin
...
vertex_scale = 0.001
# object info
objects = ["coffee_cup", "juice_carton"] #not sure what objs are in ipd
